...
<div
	class="h-max relative flex flex-col bg-white border border-neutral-400 rounded-md shadow-low active:shadow-lowest overflow-hidden cursor-pointer outline-none"
	on:click
	role="button"
	tabindex="-1"
>
