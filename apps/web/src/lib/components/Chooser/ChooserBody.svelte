...
<div
  ...
  class="fixed top-0 left-0 w-full h-full overflow-hidden md:h-fit md:absolute bg-gray-50 md:border md:border-neutral-400 md:shadow-highest md:rounded-md flex flex-col z-50 md:z-40"
>
  <div class="md:hidden">
